...
export function About() {
    ...
    return (
        <div className="items-center min-h-screen px-6 mx-auto align-middle mt-36 md:mt-0 md:flex md:max-w-4xl pb-36 md:pb-0">
            ...
            >
                <h1 className="mb-6 md:text-4xl text-secondary">Un poco sobre mí</h1>
                <p>Me destaco por mi responsabilidad y proactividad en la búsqueda constante de metas. Mi gran motivación impulsa cada proyecto que emprendo, y encuentro verdadero disfrute en el trabajo colaborativo, donde creo que la sinergia del equipo potencia los resultados. Mi capacidad para adaptarme al cambio según las necesidades del proyecto es una herramienta valiosa que aplico en cada desafío. </p>
